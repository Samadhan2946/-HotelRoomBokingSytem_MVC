...
<!-- Mirrored from codervent.com/rocker/demo/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 May 2025 08:40:11 GMT -->
<head>
<!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet"
	...
	integrity="sha512-H1+8eS1ZfKbD28UnuhYht+TycbNkNBSNZF9QkPynHfhrX/N5GvPXH8r6rZ+dH2BgHjzY37bAyCy8+52p4aUT/Q=="
...
<body>
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="resource/assets/images/logo-icon.png" class="logo-icon"
						alt="logo icon">
				</div>
				<div>
					<h4 class="logo-text">RoomBooking</h4>
				</div>
				...
				<li><a class="has-arrow" href="javascript:;">
					...
					<ul>
						<li><a href="/staff/add-staff"><i
								class='bx bx-radio-circle'></i>Staff</a></li>
				...
				<nav class="navbar navbar-expand gap-3">
						...
						<ul class="navbar-nav align-items-center gap-1">
							...
							<li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
								...
								href="avascript:;" data-bs-toggle="dropdown"><img
									src="resource/assets/images/county/02.png" width="22" alt="">
							</a>
								<ul class="dropdown-menu dropdown-menu-end">
									<li><a
										class="dropdown-item d-flex align-items-center py-2"
										href="javascript:;"><img
											src="resource/assets/images/county/01.png" width="20" alt=""><span
											class="ms-2">English</span></a></li>
									<li><a
										class="dropdown-item d-flex align-items-center py-2"
										href="javascript:;"><img
											src="resource/assets/images/county/02.png" width="20" alt=""><span
											class="ms-2">Catalan</span></a></li>
									<li><a
										class="dropdown-item d-flex align-items-center py-2"
										href="javascript:;"><img
											src="resource/assets/images/county/03.png" width="20" alt=""><span
											class="ms-2">French</span></a></li>
									<li><a
										class="dropdown-item d-flex align-items-center py-2"
										href="javascript:;"><img
											src="resource/assets/images/county/04.png" width="20" alt=""><span
											class="ms-2">Belize</span></a></li>
									<li><a
										class="dropdown-item d-flex align-items-center py-2"
										href="javascript:;"><img
											src="resource/assets/images/county/05.png" width="20" alt=""><span
											class="ms-2">Colombia</span></a></li>
									<li><a
										class="dropdown-item d-flex align-items-center py-2"
										href="javascript:;"><img
											src="resource/assets/images/county/06.png" width="20" alt=""><span
											class="ms-2">Spanish</span></a></li>
									<li><a
										class="dropdown-item d-flex align-items-center py-2"
										href="javascript:;"><img
											src="resource/assets/images/county/07.png" width="20" alt=""><span
											class="ms-2">Georgian</span></a></li>
									<li><a
										class="dropdown-item d-flex align-items-center py-2"
										href="javascript:;"><img
											src="resource/assets/images/county/08.png" width="20" alt=""><span
											class="ms-2">Hindi</span></a></li>
								</ul>
							</li>
										...
										<div
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/slack.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/behance.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/google-drive.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/outlook.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/github.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/stack-overflow.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/figma.png"
																width="30" alt="">
														</div>
														<div class="app-name">
															<p class="mb-0 mt-1">Stack</p>
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/twitter.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/google-calendar.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/spotify.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/google-photos.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/pinterest.png"
																width="30" alt="">
														</div>
														<div class="app-name">
															<p class="mb-0 mt-1">Photos</p>
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/linkedin.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/dribble.png"
																width="30" alt="">
														</div>
														<div class="app-name">
															<p class="mb-0 mt-1">Dribble</p>
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/youtube.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/google.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/envato.png"
																width="30" alt="">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="resource/assets/images/app/safari.png"
																width="30" alt="">
														</div>
														<div class="app-name">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="resource/assets/images/avatars/avatar-1.png"
											...
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="resource/assets/images/avatars/avatar-2.png"
														class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
													<h6 class="msg-name">
											...
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="resource/assets/images/avatars/avatar-4.png"
														class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
													<h6 class="msg-name">
											...
											<div class="d-flex align-items-center">
												<div class="notify bg-light-primary">
													<img src="resource/assets/images/app/github.png" width="25"
														alt="user avatar">
												</div>
												<div class="flex-grow-1">
													<h6 class="msg-name">
											...
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="resource/assets/images/avatars/avatar-8.png"
														class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
													<h6 class="msg-name">
									...
									<div class="header-message-list">
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="resource/assets/images/products/11.png" class=""
															alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
											...
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="resource/assets/images/products/02.png" class=""
															alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
											...
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="resource/assets/images/products/03.png" class=""
															alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
											...
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="resource/assets/images/products/04.png" class=""
															alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
											...
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="resource/assets/images/products/05.png" class=""
															alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
					...
					<div class="user-box dropdown px-3">
						<a
							...
							src="reassets/images/avatars/avatar-2.png" class="user-img"
							alt="user avatar">
							<div class="user-info">
	...
	<!-- Bootstrap JS -->
	<script
		src="${pageContext.request.contextPath}/resource/assets/js/bootstrap.bundle.min.js"></script>
