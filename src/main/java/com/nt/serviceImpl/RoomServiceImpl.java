...
public class RoomServiceImpl implements RoomService {
	...
	public List<AddRoomsResponseDto> getRoomList() {
		...
		try {
			ResponseEntity<List<AddRoomsResponseDto>> result = templet.exchange(url, HttpMethod.GET, entity,
					responseType);
	...
	public AddRoomsResponseDto getRoom(int id) {
		...
		try {
			...
			ResponseEntity<AddRoomsResponseDto> result = restTemplate.getForEntity(url, AddRoomsResponseDto.class);
